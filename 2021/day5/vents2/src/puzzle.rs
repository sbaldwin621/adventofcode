...
impl Solver {
    ...
    pub fn ingest(&mut self, line_segment: &LineSegment) {
        ...
        // The rounding process means that you can hit the same point twice for one line, this is to avoid that
        let mut points_traveled = HashSet::new();
